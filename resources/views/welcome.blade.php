...
<head>
  ...
  <meta charset="utf-8">
  <link href="{{asset('assets/layout/styles/layout.css')}}" rel="stylesheet" type="text/css">
  ...
  <!-- ################################ For files reder ###############################-->
  <!--PDF-->
  <link rel="stylesheet" href="{{asset('assets/include/pdf/pdf.viewer.css')}}">
  <script src="{{asset('assets/include/pdf/pdf.js')}}"></script>
  <!--Docs-->
  <script src="{{asset('assets/include/docx/jszip-utils.js')}}"></script>
  <script src="{{asset('assets/include/docx/mammoth.browser.min.js')}}"></script>
  <!--PPTX-->
  <link rel="stylesheet" href="{{asset('assets/include/PPTXjs/css/pptxjs.css')}}">
  <link rel="stylesheet" href="{{asset('assets/include/PPTXjs/css/nv.d3.min.css')}}">
  <link rel="stylesheet" href="{{asset('assets/include/revealjs/reveal.css')}}">

  <script type="text/javascript" src="{{asset('assets/include/PPTXjs/js/filereader.js')}}"></script>
  <script type="text/javascript" src="{{asset('assets/include/PPTXjs/js/d3.min.js')}}"></script>
  <script type="text/javascript" src="{{asset('assets/include/PPTXjs/js/nv.d3.min.js')}}"></script>
  <script type="text/javascript" src="{{asset('assets/include/PPTXjs/js/pptxjs.js')}}"></script>
  <script type="text/javascript" src="{{asset('assets/include/PPTXjs/js/divs2slides.js')}}"></script>
  <!--All Spreadsheet -->
  <link rel="stylesheet" href="{{asset('assets/include/SheetJS/handsontable.full.min.css')}}">
  <script type="text/javascript" src="{{asset('assets/include/SheetJS/handsontable.full.min.js')}}"></script>
  <script type="text/javascript" src="{{asset('assets/include/SheetJS/xlsx.full.min.js')}}"></script>
  <!--Image viewer-->
  <link rel="stylesheet" href="{{asset('assets/include/verySimpleImageViewer/css/jquery.verySimpleImageViewer.css')}}">
  <script type="text/javascript" src="{{asset('assets/include/verySimpleImageViewer/js/jquery.verySimpleImageViewer.js')}}"></script>
  <!--officeToHtml-->
  <script src="{{asset('assets/officeToHtml.js')}}"></script>
  <link rel="stylesheet" href="{{asset('assets/officeToHtml.css')}}">
</head>
    ...
    <main class="hoc container clear">
      ...
      <div class="content three_quarter">
        <div class="box bg-light clear">
          ...
          <p id="file_p" style="display:none;">File: <a href="#" id="a_file">
            </a><input type="file" id="select_file" />
          </p>
          <div id="description">
          ...
          (function ($) {
            $(".demos").on("click", function (e) {
              ...
              if (id != "demo_input") {
                ...
                //var file_path = "http://127.0.0.1:8000/LaravelInterviewQuestions.pdf";
